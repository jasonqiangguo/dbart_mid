...
# 
# pdf("growth_partial.pdf")
# pd_plot(model.btmchine, "gdpgrowth")
# dev.off()
...
# legend(0.32, 0.25, c(paste0("Fearon and Laitin (2003) ", FL[[2]]), paste0("Random Forest", RF[[2]]),  paste0("BART ", BT[[2]])), lty=c(1,2,3), bty="n", 
#        cex = .75)
# dev.off()
# 
